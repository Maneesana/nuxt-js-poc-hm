<template>
  <div class="max-w-screen-lg min-w-[650px] mx-auto bg-white p-8 rounded-md shadow-md  ">
    <h2 class="text-2xl font-bold mb-4">{{ previewName }} Preview</h2>

    <div class="flex items-center justify-center mb-6 overflow-hidden">
      <img :src="imageUrl" alt="Image Preview" class="rounded-md shadow-md min-w-[250px] min-h-[300px] max-h-72 overflow-hidden" />
    </div>
